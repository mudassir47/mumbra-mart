      ...
      <header className="hidden md:flex justify-between items-center p-4 bg-white shadow-sm">
        ...
        <nav>
          <ul className="flex space-x-4">
            <li><Link href="/" className="text-gray-600 hover:text-[#000050]">Home</Link></li>
            <li><Link href="/products" className="text-gray-600 hover:text-[#000050]">Products</Link></li>
            <li><Link href="/about" className="text-gray-600 hover:text-[#000050]">About</Link></li>
            <li><Link href="/contact" className="text-gray-600 hover:text-[#000050]">Contact</Link></li>
          </ul>
        </nav>
      </header>
      ...
      <main className="flex-grow pt-16 md:pt-0 pb-16 md:pb-0">
              ...
              >
                ...
                <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                  <div className="text-center px-4">
                    ...
                    <Button size="lg" variant="secondary" className="bg-white text-[#000050] hover:bg-gray-100">
                      Shop Now
                    </Button>
                  </div>
                </div>
        ...
        <Tabs defaultValue="all" className="w-full mt-8 px-4">
          <TabsList className="w-full justify-start mb-4 overflow-x-auto">
            <TabsTrigger value="all" className="data-[state=active]:bg-[#000050] data-[state=active]:text-white">All</TabsTrigger>
            <TabsTrigger value="Electronics" className="data-[state=active]:bg-[#000050] data-[state=active]:text-white">Electronics</TabsTrigger>
            <TabsTrigger value="Sports" className="data-[state=active]:bg-[#000050] data-[state=active]:text-white">Sports</TabsTrigger>
            <TabsTrigger value="Home" className="data-[state=active]:bg-[#000050] data-[state=active]:text-white">Home</TabsTrigger>
          </TabsList>
              ...
              {products.map((product) => (
                <Card key={product.id}>
                  <CardContent className="p-4">
                    ...
                    <Button className="w-full mt-4 bg-[#000050] hover:bg-[#000080]">Add to Cart</Button>
                  </CardContent>
                </Card>
              ))}
            </div>
